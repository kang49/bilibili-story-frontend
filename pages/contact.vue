<template>
    ...
    <div class="min-h-screen bg-gradient-to-r from-[#09D4FD] to-[#167BFE] hidden lg:block">
        ...
        <div class="flex">
            <img class="absolute w-[600px]" src="/img/meta_keen_avatar.png">
            <div class="mt-[90px] ml-[460px] w-full">
                <img class="absolute" src="/img/text_box.png">
                <h1 class="absolute text-white text-[20px] mt-[50px] ml-[60px] max-w-[250px]">I created this project because
                    I had
                    the same problem.</h1>
                <div class="ml-[500px]">
                    <h1 class="text-[#B5F2FF] font-bold text-[100px] drop-shadow-[0_0px_10px_rgba(181,242,255,1)]">Hello!
                    </h1>
                    <h4 class="text-white text-[40px] font-bold">I'm Meta_Keen</h4>
                </div>
                <div
